...
| **Slow March** | `drill_detection/slow_march/` | Detects step extremes (inter-leg angle peaks), scores arms/look-front/grounded-leg/raised-foot (mandatory foot gate), generates PDF report |
