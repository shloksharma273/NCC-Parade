...
def scaled_tolerances(
    ...
    #   easy (difficulty 0)  -> more lenient, hard (difficulty 5) -> stricter.
    # For "vs-target" (score_by_tolerance) and "max" bands this widens/tightens the
    # tolerance; for "min" bands (score_by_min) it lowers/raises the required minimum.
